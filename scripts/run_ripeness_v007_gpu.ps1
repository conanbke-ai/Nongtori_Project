param(
    [string]$Python = "",
    [string]$WorkDir = "artifacts/ripeness-v007-efficientnet-b0-local-gpu",
    [int]$Epochs = 15,
    [int]$Seed = 20260910
)
...
Write-Host "============================================================"
Write-Host " NONGTORI - RIPENESS V007 - EFFICIENTNET-B0 GPU SCREENING"
Write-Host "============================================================"
...
& $Python -u -m ml.ripeness_baseline.screen_backbone_v007 --workdir $WorkDir --epochs $Epochs --seed $Seed
if ($LASTEXITCODE -ne 0) { throw "V007 experiment failed. Check $WorkDir logs." }
