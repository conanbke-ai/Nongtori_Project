param(
    ...
    [int]$Epochs = 15,
    [int]$Seed = 20260910,
    [string]$Workdir = "artifacts/ripeness-v009-ordinal-head-local-gpu"
)

$ErrorActionPreference = "Stop"

Write-Host "============================================================"
Write-Host " NONGTORI - RIPENESS V009 - ORDINAL HEAD SCREENING"
Write-Host "============================================================"
...
& $Python -m ml.ripeness_baseline.screen_ordinal_v009 `
  --workdir $Workdir `
  --epochs $Epochs `
  --seed $Seed
