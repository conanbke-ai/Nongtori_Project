...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser("dryad-materialize-candidates"); p.add_argument("--candidate-manifest", type=Path, default=Path("data/audit/dryad/DATA-QUAL-002/strict-candidate-manifest.json")); p.add_argument("--output-root", type=Path, default=Path("data/raw/dryad/DATA-QUAL-002/strict-rgb")); p.add_argument("--output-manifest", type=Path, default=Path("data/audit/dryad/DATA-QUAL-002/strict-materialized-assets.json")); p.add_argument("--timeout", type=int, default=120); p.add_argument("--range-chunk-mb", type=int, default=8); p.add_argument("--checkpoint-every", type=int, default=25)
