...
2026-09-08 동일 브랜치의 로컬 작업에서 병해충 범위, 수확일지 위치, 판독 기록 댓글을 수정했다. 위 원본 대비 동일성은 최초 편입 시점의 기록이며 현재 후속 변경은 [병해충·판독 협업 흐름 문서](PEST_AND_RECORD_WORKFLOWS.md)를 따른다. 관련 API/권한 통합 테스트는 추가 실행했고 모바일/모델/field 검증은 남아 있다.
